 ...
 * abierto va a ser reemplazado. Los servicios no se pueden compartir entre
 * remotes (misma razón por la que QueryHandoffService está duplicado), así que
 * el estado viaja por una propiedad de `window`.
 *
