...
[arquitectura-producto.md](arquitectura-producto.md). Las decisiones de
diseño se documentan en [decisiones-diseno.md](decisiones-diseno.md) y
[decisiones-renderizado-grafo.md](decisiones-renderizado-grafo.md).
...
![Shell con los tableros recientes de Wikidata](../assets/01-shell-dashboard.png)
...
![Construcción visual de una consulta en RDF Explorer](../assets/02-rdf-explorer.png)
...
![Exploración coordinada de resultados en GIS Explorer](../assets/03-gis-explorer.png)
